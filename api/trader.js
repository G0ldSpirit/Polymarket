export default async function handler(req, res) {
  ...
  try {
    ...
    // Calculer stats avec les VRAIS noms de champs
    ...
    positions.forEach(p => {
      ...
      const currentValue = parseFloat(p.currentValue || p.current || 0);
      const cashPnl = parseFloat(p.cashPnl || 0);
      
      // Volume total = somme de toutes les valeurs initiales
